        ...
        <div class="mbr-cards-col col-xs-12 col-lg-4" style="padding-top: 80px; padding-bottom: 0px;">
            <div class="container">
                <div class="card cart-block">
                    ...
                    <div class="card-block">
                        <h4 class="card-title">Información de contaco</h4>
                        <h5 class="card-subtitle"></h5>
                        <p class="card-text"></p>
                ...
                <div role="form">
                   <div class="form-group">
                    ...
                    <div class="mbr-testimonial card mbr-testimonial-lg">
                        ...
                        <div class="mbr-author card-footer">
                            <div class="mbr-author-img"><img src="assets/images/face1.jpg" class="img-circle" alt="GuardarInformaciónPersonal"></div>
